...
public class StartActivity extends AppCompatActivity {
    ...
    private ArrayList<PaperOnboardingPage> getDataforOnboarding() {
        ...
        PaperOnboardingPage source = new PaperOnboardingPage("Welcome", "Welcome", Color.parseColor("#ffb174"),R.drawable.ic_baseline_rss_feed_24, R.drawable.ic_baseline_rss_feed_24);
        PaperOnboardingPage source1 = new PaperOnboardingPage("Hello", "Use our app!", Color.parseColor("#22eaaa"),R.drawable.ic_baseline_verified_user_24, R.drawable.ic_baseline_verified_user_24);
        PaperOnboardingPage source2 = new PaperOnboardingPage("", " ", Color.parseColor("#ee5a5a"),R.drawable.ic_baseline_control_camera_24, R.drawable.ic_baseline_control_camera_24);
